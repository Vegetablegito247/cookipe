...
import result from '../../images/result/result.png'
    ...
    return (
        <div className='result'>
            <div className="result_head">
                <div className="result_head_img">
                    <img src={result} alt="" />
                </div>
                <div className="result_head_text">
                    <h3>RESULT NOT FOUND</h3>
                </div>
            </div>
            <div className="result_main">
                <div className="result_main_title">
                    <h3>You may like to explore</h3>
                </div>
